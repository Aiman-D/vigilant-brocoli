...
def perform_scan(args):
    ...
    print_message("Starting the scan on base URL:", base_url, verbose=args.verbose)  # Fixed this call
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=args.threads) as executor:
        futures = {executor.submit(fetch_url, url, headers, args.ignorecertificate, args.timeout, verbose=args.verbose): url for url in urls_to_scan}  # Fixed this call
    ...
    print_message("Scan completed", verbose=args.verbose)  # Fixed this call
